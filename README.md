...
- [LMIM OS](https://lmim.tech) - Local AI OS with RAG, workspace sandbox, web scraper, contacts, voice, CUDA acceleration. Bundled model. No cloud. Linux (AppImage) + Windows (Installer). `AGPL-3.0`
